...
<body>
    ...
    <div class="card">
        ...
        <div class="card-content">
            <h2 class="name">Tema: Publicidade infantil em questão no Brasil</h2> <br>
            <p class="description">A partir da leitura dos textos motivadores e com base nos conhecimentos construídos
                ...
                língua portuguesa sobre o tema <b>"Publicidade infantil em questão no Brasil"</b>, apresentando
                ...
                forma de controlar e evitar abusos.<br>
            </p>

            <p class="font">IDOETA, P. A.; BARBA, M. D. A publicidade infantil deve ser proibida? Disponível em:
                www.bbc.co.uk. Acesso em: 23 maio 2014 (adaptado).</p>
            <br> <br>


            <p class="description"><b>TEXTO II:</b> <br>

                <img src="publicidadeinfantil.jpg">
            </p>
            <p class="font">Disponível em: www1.folha.uol.com.br. Acesso em: 24 jun. 2014 (adaptado).</p>
            <br>
            ...
            <p class="description"><b>TEXTO III:</b> <br>
                ...
                consciente de suas responsabilidades consigo mesma e com o mundo. </p>
                
            <p class="font">SILVA, A. M. D.; VASCONCELOS, L. R. A criança e o marketing: informações essenciais para
