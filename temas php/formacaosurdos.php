...
<body>
    ...
    <div class="card">
        ...
        <div class="card-content">
            <h2 class="name">Tema: Desafios para formação educacional de surdos no Brasil.</h2> <br>
            <p class="description">A partir da leitura dos textos motivadores e com base nos conhecimentos construídos
                ...
                língua portuguesa sobre o tema <b>"Desafios para formação educacional de surdos no Brasil"</b>, apresentando
                ...
                <b>CAPÍTULO IV: DO DIREITO À EDUCAÇÃO</b><br>
                ...
                forma a ampliar habilidades funcionais dos estudantes, promovendo sua autonomia e participação.<br>
            </p>

            <p class="font">BRASIL. Lei nº 13.146, de 6 de julho de 2015. Disponível em: www.planalto.gov.br. Acesso em:
                9 jun. 2017 (fragmento).</p>
            <br> <br>


            <p class="description"><b>TEXTO II:</b> <br>

                <img src="formacaodesurdos.jpg">
                <br>

            <p class="description"><b>TEXTO III:</b> <br>

                <img src="formacaodesurdos1.jpg">
            <p class="font">Disponível em: http://servicos.prt4.mpt.mp.br. Acesso em: 3 jun. 2017 (adaptado).</p>
            <br> <br>
            </p>
            ...
            <p class="description"><b>TEXTO IV:</b> <br>
                ...
                formas institucionalizadas de apoiar o uso e difusão da Libras como meio de comunicação objetiva.</p>
            <p class="font">Disponível em: www.brasil.gov.br. Acesso em: 9 jun. 2017 (adaptado).
            </p>
            </p><br>
